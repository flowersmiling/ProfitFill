...
const Card = ({ card }:any) => {
    ...
    return (
      ...
      <div className="mb-4">
        <label htmlFor="customerName" className="font-bold text-gray-600">Customer Name: {card.customerName}</label>
        <input
          id="customerName"
          name="customerName"
          type="text"
        ...
        />
        <label htmlFor="jobType" className="font-bold text-gray-600">Job Type: {card.jobType}</label>
        <select
            id="Job Type"
        ...
        <label htmlFor="status" className="font-bold text-gray-600">Status: {card.status}</label>
        <select
            id="Status"
        ...
        /><p></p>
        <label htmlFor="technician" className="font-bold text-gray-600">Technician: {card.technician}</label>
        <input
          type="text"
          id="technician"
          name="technician"
      ...
      <button onClick={() => handleDeleteJob(card.id)} className="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        Delete Job
      </button>
      </div>
    </form>
